...
interface ProfileHeaderProps {
  ...
  // No longer needs Clerk's UserResource
  user: {
    id: string;
    imageUrl?: string;
    name?: string;
    ...
    >
      ...
      <div className="relative flex items-center gap-8">
        <div className="relative group">
          ...
          />
          <div className="w-24 h-24 rounded-full border-4 border-gray-800/50 relative z-10 group-hover:scale-105 transition-transform bg-gray-800 flex items-center justify-center">
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-3xl font-bold text-white">Code Editor User</h1>
